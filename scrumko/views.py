...
from scrumko.forms import UserForm, UserProfileForm, StatusForm
...
def register(request):
	...
	status_form = StatusForm(data=request.POST)
	    ...
	    status=status_form.cleaned_data['administrator']
	    if status:
    ...
    return render_to_response(
            'scrumko/register.html',
            {'user_form': user_form, 'profile_form': profile_form, 'status_form': status_form, 'registered': registered},
            context)
